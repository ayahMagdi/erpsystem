...
const BarChart = ({chartData}) => {
  ...
  const [lastWeek , setLastWeek] = useState([])
   ...
   endLastWeek.setDate(endLastWeek.getDate() - 12);
    ...
    return (
        <div className="chart-container h-[150px] md:h-[210px] xl:h-[290px] w-full mt-1 grid grid-cols-1 md:grid-cols-2 justify-center md:justify-between gap-8">
          <div className='w-4/4 h-[150px] md:h-[210px] xl:h-[290px]  flex justify-center md:bolck'>
              <Bar  
                data={data}
                options = {{
                  scales: {
          ...
          <div className='md:h-[210px] xl:h-[290px] hidden md:block'>
              <Bar  
                data={data}
                options = {{
                  scales: {
