...
const Goback = () => {
  ...
  return (
    <div className='fixed bg-gradient-to-l from-slate-500 to-blue-600 rounded-full h-10 w-10 lg:w-16 hover:w-16 lg:hover:w-36 transition-all lg:h-16 bottom-3 left-14 cursor-pointer p-2 group z-10' onClick={() => navigate(`/${initial_url.slice(1 , -1).join('/')}`)}>
